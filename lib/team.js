...
var team = [
  ...
  member('hkeswani', 'Harsh', 'Keswani', 'Most of my recent work has been full stack development. I am passionate about design and creating disruptive ideas. I will be working on front-end development and database management.', 'Design and Routing'),
  member('zmilrod', 'Zachary', 'Milrod', 'junior', 'Design and Network'),
  member('jgatley', 'Jonathan', 'Gatley', 'junior', 'I am a software developer. My strengths and focus will be working on the front end. My main goal is to ensure that the threads and forums of the application are working as intended. The final design should be user-friendly and functional.')
