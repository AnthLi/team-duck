...
var team = [
  ...
  member('hkeswani', 'Harsh', 'Keswani', 'Hello there, I’m a student at UMass Amherst. I study Computer Science. I lived in Mumbai till I was 18 and then moved to the US to get my Bachelors degree.
Most of my recent work has been full stack development. I am passionate about design and creating disruptive ideas. I will be working on front-end development and database management for this project.', 'Design, Routing and Database'),
<<<<<<< HEAD
  member('zmilrod', 'Zachary', 'Milrod', 'My work so far has been mainly front-end work making static websites. However, I am interested in backend work and hope to learn and use those new skills in this application. I will be working on the Design and Network.', 'Design and Network'),
  member('jgatley', 'Jonathan', 'Gatley', 'I am a software developer. My strengths and focus will be working on the front end. My main goal is to ensure that the threads and forums of the application are working as intended. The final design should be user-friendly and functional.', 'Front End Developer')
=======
...
>>>>>>> cda4d4d8b6245c422cb3e1083d787e0a4a38e3f9
