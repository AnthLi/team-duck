...
var team = [
  ...
  member('jgatley', 'Jonathan', 'Gatley', 'I am a software developer. My strengths and focus will be working on the front end. My main goal is to ensure that the threads and forums of the application are working as intended. The final design should be user-friendly and functional.')
